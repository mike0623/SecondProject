    ...
    <form action="UpdateUserInfo.do" method="post" >
		<fieldset class="form" >
            ...
            <table class="table">
                ...
                <tr>
                    <td>*密碼:</td>
                    <td><input id="updatePwd" type="password" name="updatePwd" value="${myUser.userPwd }" placeholder="請輸入密碼:"></td>
                </tr>
                <tr>
                    <td>*請再次輸入密碼:</td>
                    <td><input id="testPwd" type="password" name="testPwd" value="${myUser.userPwd }" placeholder="請再次輸入密碼:"></td>
                </tr>
                <tr>
                    <td>*姓名:</td>
